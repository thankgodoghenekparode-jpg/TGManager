        ...
        <Stack spacing={2}>
          ...
          <Paper variant="outlined" sx={{ p: 3 }}>
            ...
            <Stack spacing={2}>
              ...
              <TextField label="From email" type="email" value={form.smtpFromEmail ?? ''} disabled={disabled} onChange={(e) => set('smtpFromEmail', e.target.value)} fullWidth placeholder="TGManager <no-reply@example.com>" />
            </Stack>
          </Paper>
