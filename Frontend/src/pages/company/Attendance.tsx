...
export function ClockDialog({
  ...
  const [verification, setVerification] = useState<BiometricVerification | null>(null)
    ...
    <Dialog open onClose={onCancel} fullWidth maxWidth="xs">
      ...
      <DialogContent sx={{ px: { xs: 2, sm: 3 }, pt: { xs: 1.5, sm: 2 } }}>
        <Stack spacing={2} sx={{ pt: 1, minWidth: { xs: 'auto', sm: 320 } }}>
          ...
          <BiometricClockIn onVerified={setVerification} disabled={busy} />
        </Stack>
      </DialogContent>
      <DialogActions sx={{ px: { xs: 2, sm: 3 }, pb: { xs: 2, sm: 2 }, flexWrap: 'wrap' }}>
        ...
        <Button
          ...
          disabled={busy || !position || !within || !verification}
