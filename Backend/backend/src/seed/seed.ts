...
const PLATFORM_USERS: SeedUser[] = [
  {
    email: 'super@zarox.com',
    firstName: 'Platform',
    lastName: 'Owner',
    platformRole: 'SUPER_ADMIN',
  },
  {
    email: 'support@zarox.com',
    firstName: 'Support',
    lastName: 'Agent',
...
const DEMO_USERS: SeedUser[] = [
  {
    email: 'admin@zarox-demo.com',
    firstName: 'Demo',
    lastName: 'Admin',
    platformRole: 'COMPANY_ADMIN',
  },
  {
    email: 'ada.okafor@zarox-demo.com',
    firstName: 'Ada',
    lastName: 'Okafor',
    platformRole: 'BRANCH_ADMIN',
  },
  {
    email: 'emeka.nwosu@zarox-demo.com',
    firstName: 'Emeka',
    lastName: 'Nwosu',
    platformRole: 'BRANCH_ADMIN',
  },
  {
    email: 'fatima.ali@zarox-demo.com',
    firstName: 'Fatima',
    lastName: 'Ali',
    platformRole: 'BRANCH_ADMIN',
  },
  {
    email: 'james.balogun@zarox-demo.com',
    firstName: 'James',
    lastName: 'Balogun',
    platformRole: 'USER',
  },
  {
    email: 'grace.ekpo@zarox-demo.com',
    firstName: 'Grace',
    lastName: 'Ekpo',
    platformRole: 'USER',
  },
  {
    email: 'chidi.obi@zarox-demo.com',
    firstName: 'Chidi',
    lastName: 'Obi',
    platformRole: 'USER',
  },
  {
    email: 'sade.adeyemi@zarox-demo.com',
    firstName: 'Sade',
    lastName: 'Adeyemi',
    platformRole: 'USER',
  },
  {
    email: 'bola.ogundimu@zarox-demo.com',
    firstName: 'Bola',
    lastName: 'Ogundimu',
    platformRole: 'USER',
  },
  {
    email: 'kunle.fashola@zarox-demo.com',
    firstName: 'Kunle',
    lastName: 'Fashola',
    platformRole: 'USER',
  },
  {
    email: 'amara.okonkwo@zarox-demo.com',
    firstName: 'Amara',
    lastName: 'Okonkwo',
    platformRole: 'USER',
  },
  {
    email: 'tunde.ibrahim@zarox-demo.com',
    firstName: 'Tunde',
    lastName: 'Ibrahim',
    platformRole: 'USER',
  },
  ...
  return prisma.$transaction(async (tx) => {
    ...
    const depts = await Promise.all([
      tx.department.create({
        data: {
          ...
          branchId: lagos.id,
          name: 'Engineering',
          managerUserId: userMap['james.balogun@zarox-demo.com'],
        },
      }),
      tx.department.create({
        data: {
          ...
          branchId: lagos.id,
          name: 'Operations',
          managerUserId: userMap['grace.ekpo@zarox-demo.com'],
        },
      }),
      tx.department.create({
        data: {
          ...
          branchId: abuja.id,
          name: 'HR',
          managerUserId: userMap['amara.okonkwo@zarox-demo.com'],
        },
      }),
      tx.department.create({
        data: {
          ...
          branchId: abuja.id,
          name: 'Finance',
          managerUserId: userMap['tunde.ibrahim@zarox-demo.com'],
        },
      }),
      tx.department.create({
        data: {
          ...
          branchId: ph.id,
          name: 'Sales',
          managerUserId: userMap['chidi.obi@zarox-demo.com'],
        },
      }),
      tx.department.create({
        data: {
    ...
    const companyAdminRole = await tx.companyRole.create({
      data: {
        ...
        createdByUserId: userMap['admin@zarox-demo.com'],
      },
    });
    ...
    const adminId = userMap['admin@zarox-demo.com'];

    // Platform users
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['super@zarox.com'],
      companyRoleId: companyAdminRole.id,
      assignedByUserId: adminId,
    });
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['support@zarox.com'],
    ...
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['ada.okafor@zarox-demo.com'],
    ...
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['emeka.nwosu@zarox-demo.com'],
      companyRoleId: branchAdminRole.id,
      branchId: abuja.id,
      assignedByUserId: adminId,
    });
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['fatima.ali@zarox-demo.com'],
      companyRoleId: branchAdminRole.id,
      branchId: ph.id,
      assignedByUserId: adminId,
    });
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['james.balogun@zarox-demo.com'],
    ...
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['grace.ekpo@zarox-demo.com'],
    ...
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['chidi.obi@zarox-demo.com'],
    ...
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['sade.adeyemi@zarox-demo.com'],
      companyRoleId: staffRole.id,
      branchId: lagos.id,
      assignedByUserId: adminId,
    });
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['bola.ogundimu@zarox-demo.com'],
      companyRoleId: staffRole.id,
      branchId: lagos.id,
      assignedByUserId: adminId,
    });
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['kunle.fashola@zarox-demo.com'],
      companyRoleId: salesRepRole.id,
      branchId: ph.id,
      assignedByUserId: adminId,
    });
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['amara.okonkwo@zarox-demo.com'],
      companyRoleId: deptManagerRole.id,
      branchId: abuja.id,
      assignedByUserId: adminId,
    });
    roleAssignments.push({
      tenantId: demoTenant.id,
      userId: userMap['tunde.ibrahim@zarox-demo.com'],
      companyRoleId: deptManagerRole.id,
      branchId: abuja.id,
      assignedByUserId: adminId,
    });
    ...
    const sgData: { staffRecordId: string; groupId: string }[] = [
      ...
      {
        staffRecordId: staffByEmail[userMap['ada.okafor@zarox-demo.com']],
        groupId: seniorTeam.id,
      },
      {
        staffRecordId: staffByEmail[userMap['james.balogun@zarox-demo.com']],
        groupId: seniorTeam.id,
      },
      {
        staffRecordId: staffByEmail[userMap['sade.adeyemi@zarox-demo.com']],
        groupId: newIntake.id,
      },
      {
        staffRecordId: staffByEmail[userMap['bola.ogundimu@zarox-demo.com']],
        groupId: newIntake.id,
      },
      {
        staffRecordId: staffByEmail[userMap['emeka.nwosu@zarox-demo.com']],
        groupId: abujaCore.id,
      },
      {
        staffRecordId: staffByEmail[userMap['amara.okonkwo@zarox-demo.com']],
        groupId: abujaCore.id,
      },
      {
        staffRecordId: staffByEmail[userMap['tunde.ibrahim@zarox-demo.com']],
        groupId: abujaCore.id,
      },
      {
        staffRecordId: staffByEmail[userMap['fatima.ali@zarox-demo.com']],
        groupId: fieldWorkers.id,
      },
      {
        staffRecordId: staffByEmail[userMap['chidi.obi@zarox-demo.com']],
        groupId: fieldWorkers.id,
      },
    ];
    ...
    const incidentForm = await tx.form.create({
      data: {
        tenantId: demoTenant.id,
        branchId: ph.id,
        createdByUserId: userMap['fatima.ali@zarox-demo.com'],
      ...
      data: [
        {
          ...
          submittedByUserId: userMap['sade.adeyemi@zarox-demo.com'],
          data: {
        ...
        },
        {
          ...
          submittedByUserId: userMap['bola.ogundimu@zarox-demo.com'],
          data: {
        ...
        },
        {
          ...
          submittedByUserId: userMap['kunle.fashola@zarox-demo.com'],
          data: {
            date: '2026-08-20',
            amount: 45000,
        ...
        },
        {
          ...
          submittedByUserId: userMap['chidi.obi@zarox-demo.com'],
          data: {
            date: '2026-08-22',
            amount: 120000,
        ...
        },
        {
          ...
          submittedByUserId: userMap['fatima.ali@zarox-demo.com'],
          data: {
            date: '2026-08-18',
    ...
    const wfLeaveApproved = await tx.workflowInstance.create({
      data: {
        ...
        status: 'APPROVED',
        initiatedByUserId: userMap['sade.adeyemi@zarox-demo.com'],
        payload: {
      ...
      data: [
        {
          ...
          stepId: leaveStep1.id,
          status: 'COMPLETED',
          assignedToUserId: userMap['ada.okafor@zarox-demo.com'],
          actionedById: userMap['ada.okafor@zarox-demo.com'],
        ...
        },
        {
          ...
          status: 'COMPLETED',
          assignedToUserId: userMap['amara.okonkwo@zarox-demo.com'],
          actionedById: userMap['amara.okonkwo@zarox-demo.com'],
    ...
    const wfLeavePending = await tx.workflowInstance.create({
      data: {
        ...
        status: 'PENDING',
        initiatedByUserId: userMap['bola.ogundimu@zarox-demo.com'],
        payload: {
          start_date: '2026-09-10',
          end_date: '2026-09-12',
          reason: 'Medical appointment',
    ...
    await tx.workflowStepInstance.create({
      data: {
        ...
        stepId: leaveStep1.id,
        status: 'PENDING',
        assignedToUserId: userMap['grace.ekpo@zarox-demo.com'],
      },
    });
    ...
    const wfExpenseApproved = await tx.workflowInstance.create({
      data: {
        ...
        status: 'APPROVED',
        initiatedByUserId: userMap['kunle.fashola@zarox-demo.com'],
        payload: {
          date: '2026-08-20',
          amount: 45000,
          description: 'Client meeting transport',
      ...
      data: [
        {
          ...
          stepId: expenseStep1.id,
          status: 'COMPLETED',
          assignedToUserId: userMap['fatima.ali@zarox-demo.com'],
          actionedById: userMap['fatima.ali@zarox-demo.com'],
        ...
        },
        {
          ...
          status: 'COMPLETED',
          assignedToUserId: userMap['tunde.ibrahim@zarox-demo.com'],
          actionedById: userMap['tunde.ibrahim@zarox-demo.com'],
          actionedAt: d(2026, 8, 22),
        },
      ],
    });
    ...
    const wfExpenseRejected = await tx.workflowInstance.create({
      data: {
        ...
        status: 'REJECTED',
        initiatedByUserId: userMap['chidi.obi@zarox-demo.com'],
        payload: {
          date: '2026-08-22',
          amount: 120000,
          description: 'Team lunch — sales closing',
    ...
    const memoWelcome = await tx.memo.create({
      data: {
        ...
        branchId: lagos.id,
        createdByUserId: adminId,
        title: 'Welcome to Zarox Connect',
        body: [
          'Welcome to the team! This memo introduces you to the Zarox Connect platform.',
      ...
      data: [
        {
          ...
          createdByUserId: userMap['james.balogun@zarox-demo.com'],
        },
        {
          tenantId: demoTenant.id,
          branchId: lagos.id,
        ...
        },
        {
          ...
          createdByUserId: userMap['emeka.nwosu@zarox-demo.com'],
        },
        {
          tenantId: demoTenant.id,
          branchId: ph.id,
    ...
    await tx.document.createMany({
      data: [
        ...
        },
        {
          tenantId: demoTenant.id,
          branchId: abuja.id,
          createdByUserId: userMap['tunde.ibrahim@zarox-demo.com'],
    ...
    await Promise.all([
      ...
      tx.message.create({
        data: {
          conversationId: directConv.id,
          senderId: userMap['ada.okafor@zarox-demo.com'],
    ...
    await tx.message.createMany({
      data: [
        ...
        {
          conversationId: groupConv.id,
          senderId: userMap['james.balogun@zarox-demo.com'],
